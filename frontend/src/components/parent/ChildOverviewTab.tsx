      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
          <div className="flex items-center justify-between">
            ...
            <div className="h-12 w-12 rounded-lg bg-blue-50 p-3 dark:bg-gray-700">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
          <div className="flex items-center justify-between">
            ...
            <div className="h-12 w-12 rounded-lg bg-green-50 p-3 dark:bg-gray-700">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
          <div className="flex items-center justify-between">
            ...
            <div className="h-12 w-12 rounded-lg bg-purple-50 p-3 dark:bg-gray-700">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
          <div className="flex items-center justify-between">
            ...
            <div className="h-12 w-12 rounded-lg bg-orange-50 p-3 dark:bg-gray-700">
        ...
        <div className="space-y-3">
          {childProgress.weeklyProgress.map((week) => (
            <div key={week.week} className="space-y-2">
              ...
              <div className="flex h-2 gap-1 overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
                <div
        ...
        <div className="space-y-3">
          {childProgress.teacherNotes.length > 0 ? (
            childProgress.teacherNotes.map((note) => (
              <div key={note.id} className="border-l-4 border-primary-500 bg-blue-50 p-3 dark:bg-gray-700">
