...
const STUDENT_NAV: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Transport',       path: '/student/transport',     icon: Bus },
    ],
  },
  {
    title: 'Growth',
  ...
  return [
    {
      items: [
        ...
        { label: 'AI Assistant',             path: `${basePath}/ai-assistant`,  icon: Bot },
  ...
  return [
    {
      items: [
        ...
        { label: 'Fees',                    path: '/parent/fees',          icon: Receipt },
        { label: 'Transport',               path: '/parent/transport',     icon: Bus },
        { label: 'Child Events',            path: '/parent/events',        icon: Ticket },
        { label: 'AI Assistant',            path: '/parent/ai-assistant',  icon: Bot },
  ...
  return [
    {
      items: [
        ...
        { label: 'Staff & HR',              path: '/admin/staff',         icon: UserCog },
        { label: 'Fees',                    path: '/admin/fees',          icon: Receipt },
